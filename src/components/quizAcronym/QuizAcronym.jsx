...
const QuizAcronym = () => {
  ...
  const getDatas = async () => {
    const response = await fetch("https://scuba-diving-quiz-version-101.p.rapidapi.com/trivia/acronym", {
      	"method": "GET",
      	"headers": {
      ...
      <ScQuiz>
          <Container>
            ...
            {quizDatas && !showScore && (
              ...
              <p className='quizQuestion'>What does {quizDatas[currentQuestion].questionText} stands for?</p>
